...
let displayProduct = products.map(function(value,index,array) {
    return `
        <div class="text-2xl font-bold shadow-lg max-w-70 text-center relative p-4">
            <img class="pt-10 w-100" src="images/${value.image}">
            <p class="">Name: ${value.name}</p>
            <p>Price: ${value.price}</p>
            <div class="absolute top-2 right-1 "><p class=" line-through text-orange-500">Discount: ${value.discount}</p></div>
